...
class DaikinCloudDevice {
     ...
     */
    async updateData() {
        // TODO: Enhance this method to also allow to get some partial data liek only one managementPoint or such; needs checking how to request
    ...
    async setData(managementPoint, dataPoint, dataPointPath, value) {
        ...
        if (!this.managementPoints[managementPoint][dataPoint] || (dataPointPath && !this.managementPoints[managementPoint][dataPoint][dataPointPath])) {
